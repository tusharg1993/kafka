...
public class KafkaBufferedInputStream extends BufferedInputStream {
  protected final BufferSupplier bufferSupplier;
  protected final ByteBuffer byteBuffer;

  private boolean closed = false;

  public KafkaBufferedInputStream(InputStream in, int size, BufferSupplier bufferSupplier) {
    super(in, 0);
